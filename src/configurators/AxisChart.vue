<template>
  <div>
    ...
    <div class="flex flex-wrap -mx-3 mb-4">
      ...
      <Data label="Start" placeholder="-10" v-model="chartConfig.data.yRegions[0].start" width="third" />
      <Data label="End" placeholder="50" v-model="chartConfig.data.yRegions[0].end" width="third" />
    </div>
  </div>
</template>
<script>
